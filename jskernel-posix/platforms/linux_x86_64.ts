...
export namespace buffer {
    export var uInt8    = Buffer.prototype.readUInt8    as util.Tmethod;
    export var int8     = Buffer.prototype.readInt8     as util.Tmethod;
...
export namespace struct {
    ...
    class Struct implements IType {
        static create(size, defs) {
    ...
    export var stat = Struct.create(31 * 4, [
        [0, int32, 'dev'],
